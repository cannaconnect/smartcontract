...
export interface SaleTokenInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "buy"
      | "getRemainingToken"
  ...
  encodeFunctionData(
    functionFragment: "totalTokenSale",
    values?: undefined
  ): string;
  encodeFunctionData(
...
export interface SaleToken extends BaseContract {
  connect(runner?: ContractRunner | null): SaleToken;
  ...
  totalTokenSale: TypedContractMethod<[], [bigint], "view">;
  ...
  getFunction(
    nameOrSignature: "totalTokenSale"
  ): TypedContractMethod<[], [bigint], "view">;
  getFunction(
